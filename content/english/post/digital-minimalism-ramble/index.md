---
title: My Own Take on Digital Minimalism and Why Is It Aligns With My Privacy & Security stand
description: Honestly, it's just a ramble about why you shouldn't buy Flip Phones just to avoid doomscrolling. Or at least, that's why I was pushed to write this shit. x)
...
1. Those devices use old Android versions and can cost security issues and are easy to hack and send viruses to. I can’t recommend wholeheartedly to switch to “dumb phones” knowing this.
2. You don’t need those devices to detox yourself. You don’t need to get vulnerable ￼in your security in order to live without socials. Security isn’t the price for digital privacy. You can use your **current** device and still detox yourself!
